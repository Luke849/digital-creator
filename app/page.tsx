...
const PreorderForm = () => {
  ...
  return (
    <div className={`${darkMode && "dark"} dark-mode`}>
      <div className="relativ flex flex-col min-h-screen animate-fadeIn dark:bg-zinc-900 overflow-hidden">
        ...
        <main className="flex-1">
          <section className="relative top-[50vh] translate-y-[-50%] w-full h-screen flex items-center justify-center z-10">
            <div className="container px-4 mx-4 md:px-6">
              <div className="flex flex-col items-center space-y-4 text-center">
                <div className="space-y-2 animate-slideInFromBottom">
                  <h1 className=" font-bold tracking-tighter text-5xl lg:text-6xl/none dark:text-zinc-50">
          ...
          <section className="py-10 z-20 relative w-full" id="bento">
            <div ref={ref}>
            <motion.div
            initial="initial"
            ...
            className="mx-6 md:mx-20 md:pt-20 grid grid-cols-12 gap-3 text-center md:h-[80vh] md:my-10 backdrop-blur-sm">
              <Block className="col-span-12 md:col-span-4 group">
                ...
                <div className="relative w-full h-32">
                  <div className="absolute min-full bottom-8 left-1/2 -translate-x-1/2">
                    ...
                    <motion.div
                      ...
                      className="opacity-1 flex justify-end -translate-x-4 -translate-y-4">
                    <img src="cursor.png" alt="cursor" />
                  </motion.div>
                  </div>
                </div>
              </Block>
              <Block className="col-span-12 h-[30vh] md:hidden">
              ...
              <Block className="col-span-12 md:col-span-5 ">
                <div className="flex justify-between items-center h-full" ref={layoutRef}>
                  <div className="w-full pr-3 text-sm text-left">
                  ...
                  <div className="flex w-[70%] justify-end md:justify-center float-right">
                    <div className="w-full h-full md:w-60 md:h-40 bg-zinc-200 dark:bg-zinc-800 rounded-md p-3">
                      <div className="flex justify-between">
                        <motion.div
                          ...
                          className="w-4/12 h-7 md:w-36 md:h-20 bg-zinc-50 dark:bg-zinc-900 rounded-md"/>
                        <motion.div
                          variants={{
                            initial: {
                              y: 0,
                          ...
                          initial="initial"
                          animate={layoutControls}
                          className="w-7/12 h-7 md:w-14 md:h-20 bg-zinc-50 dark:bg-zinc-900 rounded-md"/>
                      </div>
                      <motion.div
                        variants={{
                          initial: {
                        ...
                        initial="initial"
                        animate={layoutControls}
                        className="w-full h-7 md:h-11 mt-2 md:mt-3 bg-zinc-50 dark:bg-zinc-900 rounded-md"></motion.div>
                    </div>
                  </div>
                </div>
              </Block>
              <Block className="col-span-12 md:col-span-3 md:row-span-3 h-[60vh] md:h-auto"> 
                <div className="flex flex-col items-center justify-center min-h-full dark:text-zinc-50 font-semibold">
                  <div>Mobile Mockup</div>
                  <div>coming soon...</div>
                </div>
              </Block>
              <Block className="col-span-7 row-span-3 hidden md:block">
                <div className="flex flex-col items-center justify-center min-h-full dark:text-zinc-50 font-semibold">
                  <div>Desktop Mockup</div>
                  <div>coming soon...</div>
                </div>
              </Block>
              <Block className="col-span-12 md:col-span-2 row-span-3 p-0 h-full md:h-auto group">
                ...
                <div className="p-0 h-40">
                  <div className="relative flex items-center justify-center w-full bg-transparent">
                    ...
                    className="absolute w-1/3 h-[10vh] border border-dashed border-zinc-950 dark:border-zinc-50 top-0 left-6 animate-customization-sm delay-1000 md:animate-none">
              ...
              <Block className="col-span-3 cursor-blue hidden md:block">
                <div className="text-sm text-left w-44 mb-10">
                      <h2 className="text-xl font-bold dark:text-zinc-50">Export</h2>
                      <p className="text-zinc-500">
                        <span className="dark:text-primary-blue text-primary-blue font-semibold">You</span> can export your digital products to Notion or as HTML, CSS, and JS files.
                      </p>
        ...
        <div className="animate-none">
          <div className="absolute top-[30vh] left-[30vw] w-60 h-60 bg-primary-blue rounded-full filter blur-3xl dark:opacity-40 opacity-70 -z-10 dark:z-0 md:block hidden"></div>
          ...
          <div className="absolute top-[65vh] left-[35vw] w-80 h-80 bg-primary-blue rounded-full filter blur-3xl opacity-60 -z-10 dark:z-0 md:block hidden"></div>
          <div className="absolute top-[105vh] right-0 md:left-[15vw] w-80 h-80 bg-primary-blue rounded-full filter blur-3xl opacity-70 -z-10 dark:z-0"></div>
          <div className="absolute top-[130vh] right-[10vw] w-80 h-80 bg-primary-blue rounded-full filter blur-3xl opacity-50 -z-10 dark:z-0 md:block hidden"></div>
          <div className="md:hidden">
          <div className="absolute top-[180vh] -left-[10vw] w-52 h-52 bg-primary-blue rounded-full filter blur-3xl opacity-50 -z-10 dark:z-0"></div>
            <div className="absolute top-[240vh] w-80 h-80 bg-primary-blue rounded-full filter blur-3xl opacity-40 -z-10 dark:z-0"></div>
            <div className="absolute top-[280vh] right-0 w-60 h-60 bg-primary-blue rounded-full filter blur-3xl opacity-80 -z-10 dark:z-0"></div>
          </div>
